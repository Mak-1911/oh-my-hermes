...
OMH는 **100개**의 설치형 workflow skill을 사람이 이해하기 쉬운 6개 기능군으로
제공합니다.

그중 10개는 workflow engine입니다 - `deep-interview`, `loop`, `ralph`, `ralplan`, `team`, `ultragoal`, `ultraprocess`, `ultraqa`, `ultrawork`, `web-research` - 이들은 `ulw-` 라벨로 렌더링되어
