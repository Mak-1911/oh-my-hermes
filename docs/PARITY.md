...
| Loop and autopilot workflow | Available | `loop`, `ultrawork`, `ralplan`, loop queue ticks, verification tiers, and failure-mode cards. | Scheduling, connector I/O, worktree creation, and subagent execution remain prepared or delegated until observed. |
