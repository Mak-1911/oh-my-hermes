...
class HermesUxQualityTests(unittest.TestCase):
    def test_hermes_ux_quality_rolls_up_user_visible_contracts(self) -> None:
        ...
        self.assertEqual(payload["summary"]["chat_card_cases"], 71)
        self.assertEqual(payload["summary"]["chat_card_generic_ack_count"], 0)
        self.assertEqual(payload["summary"]["route_hint_cases"], 191)
        self.assertEqual(payload["summary"]["route_hint_aligned_count"], 191)
        ...
        self.assertEqual(payload["summary"]["routing_precision_cases"], 56)
        self.assertEqual(payload["summary"]["routing_precision_passing_count"], 56)
        ...
        self.assertEqual(payload["summary"]["routing_precision_intervention_cases"], 137)
        self.assertEqual(payload["summary"]["routing_precision_intervention_passing_count"], 137)
