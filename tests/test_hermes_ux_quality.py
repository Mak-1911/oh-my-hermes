...
class HermesUxQualityTests(unittest.TestCase):
    def test_hermes_ux_quality_rolls_up_user_visible_contracts(self) -> None:
        ...
        self.assertEqual(payload["summary"]["chat_card_cases"], 60)
        self.assertEqual(payload["summary"]["chat_card_generic_ack_count"], 0)
        self.assertEqual(payload["summary"]["route_hint_cases"], 180)
        self.assertEqual(payload["summary"]["route_hint_aligned_count"], 180)
        ...
        self.assertEqual(payload["summary"]["routing_precision_cases"], 55)
        self.assertEqual(payload["summary"]["routing_precision_passing_count"], 55)
        ...
        self.assertEqual(payload["summary"]["routing_precision_intervention_cases"], 127)
        self.assertEqual(payload["summary"]["routing_precision_intervention_passing_count"], 127)
