...
class HermesUxQualityTests(unittest.TestCase):
    def test_hermes_ux_quality_rolls_up_user_visible_contracts(self) -> None:
        ...
        self.assertEqual(payload["summary"]["chat_card_cases"], 76)
        self.assertEqual(payload["summary"]["chat_card_generic_ack_count"], 0)
        self.assertEqual(payload["summary"]["route_hint_cases"], 196)
        self.assertEqual(payload["summary"]["route_hint_aligned_count"], 196)
        ...
        self.assertEqual(payload["summary"]["routing_precision_cases"], 64)
        self.assertEqual(payload["summary"]["routing_precision_passing_count"], 64)
        ...
        self.assertEqual(payload["summary"]["routing_precision_intervention_cases"], 173)
        self.assertEqual(payload["summary"]["routing_precision_intervention_passing_count"], 173)
        ...
        self.assertEqual(payload["summary"]["common_request_cases"], 91)
        self.assertEqual(payload["summary"]["common_request_passing_count"], 91)
    ...
    def test_hermes_ux_quality_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("common requests 91/91", stdout)
