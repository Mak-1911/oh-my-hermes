...
class HermesUxQualityTests(unittest.TestCase):
    def test_hermes_ux_quality_rolls_up_user_visible_contracts(self) -> None:
        ...
        self.assertEqual(payload["summary"]["routing_precision_intervention_cases"], 118)
        self.assertEqual(payload["summary"]["routing_precision_intervention_passing_count"], 118)
