...
class ArchitectureLayoutTests(unittest.TestCase):
    ...
    def test_root_compatibility_facades_stay_thin(self) -> None:
        ...
        facades = {
            ...
            "src/omh/external_effect_receipts.py": "from .workflows.external_effect_receipts import *  # noqa: F401,F403",
            ...
            "src/omh/owner_progress_normalization.py": "from .coding.owner_progress_normalization import *  # noqa: F401,F403",
