...
class ReleaseSmokeTests(unittest.TestCase):
    ...
    def test_product_readiness_report_rolls_up_public_release_story(self) -> None:
        with TemporaryDirectory() as tmp:
            ...
            self.assertIn("76/76 dedicated workflow cards", gates["chat_card_coverage"]["summary"])
    ...
    def test_release_evidence_bundle_packages_and_writes_local_evidence(self) -> None:
        with TemporaryDirectory() as tmp:
            ...
            self.assertEqual(payload["summary"]["chat_card_coverage_total"], 76)
            ...
            self.assertEqual(payload["summary"]["route_hint_alignment_total"], 196)
