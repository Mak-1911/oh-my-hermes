...
class RouterContentTests(unittest.TestCase):
    ...
    def test_first_release_trust_surfaces_are_present(self) -> None:
        ...
        self.assertIn("**oh-my-hermes** (OMH) turns a normal request", readme)
        self.assertIn("replacing Hermes or hiding a coding executor", readme)
        self.assertIn("**82 installable workflow skills**", readme)
        self.assertIn("**82개**", localized_readmes["ko"])
        self.assertIn("**82 個**", localized_readmes["ja"])
        self.assertIn("**82 个**", localized_readmes["zh"])
        ...
        self.assertIn("People normally talk to Hermes and use only three OMH maintenance commands", docs_readme)
        ...
        self.assertIn("choose one of six capability families", readme)
        ...
        self.assertIn("**82 installable skills**", docs_readme)
