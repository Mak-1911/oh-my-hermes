...
class RouterContentTests(unittest.TestCase):
    ...
    def test_first_release_trust_surfaces_are_present(self) -> None:
        ...
        self.assertIn("**102 installable workflow skills**", readme)
        self.assertIn("**102개**", localized_readmes["ko"])
        self.assertIn("**102 個**", localized_readmes["ja"])
        self.assertIn("**102 个**", localized_readmes["zh"])
        ...
        self.assertIn("omh release checklist --version 1.0.4 --json", release)
        ...
        self.assertIn("oh_my_hermes-1.0.4-py3-none-any.whl", release)
