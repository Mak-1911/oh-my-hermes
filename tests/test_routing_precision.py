...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["case_count"], 67)
        self.assertEqual(payload["summary"]["passing_count"], 67)
        self.assertEqual(payload["summary"]["negative_case_count"], 67)
        self.assertEqual(payload["summary"]["negative_passing_count"], 67)
        self.assertEqual(payload["summary"]["direct_answer_count"], 61)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 178)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 178)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 245)
        self.assertEqual(payload["summary"]["total_passing_count"], 245)
        ...
        self.assertEqual(interventions["hindi-research"]["observed"]["route_workflow"], "research")
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("67/67 negative-control cases passing", stdout)
        self.assertIn("Interventions: 178/178 expected workflow cases passing", stdout)
