...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["case_count"], 56)
        self.assertEqual(payload["summary"]["passing_count"], 56)
        self.assertEqual(payload["summary"]["negative_case_count"], 56)
        self.assertEqual(payload["summary"]["negative_passing_count"], 56)
        self.assertEqual(payload["summary"]["direct_answer_count"], 53)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 129)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 129)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 185)
        self.assertEqual(payload["summary"]["total_passing_count"], 185)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("56/56 negative-control cases passing", stdout)
        self.assertIn("Interventions: 129/129 expected workflow cases passing", stdout)
