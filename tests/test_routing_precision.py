...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 137)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 137)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 193)
        self.assertEqual(payload["summary"]["total_passing_count"], 193)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("Interventions: 137/137 expected workflow cases passing", stdout)
