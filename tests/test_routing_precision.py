...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 150)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 150)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 207)
        self.assertEqual(payload["summary"]["total_passing_count"], 207)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("Interventions: 150/150 expected workflow cases passing", stdout)
