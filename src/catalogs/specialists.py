...
_SPECIALISTS = (
    SpecialistDefinition(
        ...
        eligible_skill_ids=("research", "best-practice-research", "research-brief", "source-finder", "research-department"),
    ...
    SpecialistDefinition(
        ...
        eligible_skill_ids=("deep-interview", "plan", "ralplan", "loop", "curriculum-design", "product-brief"),
