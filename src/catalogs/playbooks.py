...
_SURFACE_PLAYBOOKS = (
    ...
    _surface_playbook(
        "memory-new",
        "New memory capture",
        "Add new project, product, or durable context candidates through capture, review, and approval.",
        "Use when new durable context should be proposed for OMH project memory, optional Hermes native memory, or both.",
        (
            "memory-new",
            "new memory",
            "project memory",
        ...
        owner="memory-new",
        contract="memory_new_candidate/v1",
        pipeline=("capture_candidate", "review_candidate", "approve_candidate", "record_target_write"),
        first_action="capture_candidate",
    ...
    _surface_playbook(
        ...
        "Review stale, conflicting, duplicate, overgeneralized, or risky existing USER.md, MEMORY.md, and skill memories through approve/reject/update actions.",
        "Use when accumulated existing Hermes memory or skill guidance needs human-approved cleanup, not new-memory capture.",
        (
            "memory",
            "curation",
            "stale",
    ...
    _surface_playbook(
        ...
        contract="ops_service_quality_board/v1",
        pipeline=("scope_telemetry", "accept_metric_provider_payload", "summarize_metrics", "type_service_quality_gaps", "check_failure_modes", "record_observation"),
