...
_RULES = (
    ...
    CoverageRule(
        ...
        "OMH can use official-style plugin examples to review package shape, tool schemas, prompt imports, connector scope, and verification gates before any plugin is installed or trusted.",
    ...
    CoverageRule(
        (
            ...
            "evey hermes plugins",
            "discord voice bridge with gemini live",
            "goal management inter agent bridge",
            "inter agent bridge model selection",
            "model selection and cost control",
            "evey bridge plugin",
            "bridging with evey",
            "share context and hand off tasks",
            "evey council",
            "evey delegate model",
        ),
        "partial",
        ...
        "OMH can review public Evey/Hermes orchestration plugins for handoff, model routing, cost, and bridge boundaries while external bridges and model/provider calls remain observed-only.",
    ...
    CoverageRule(
        (
            ...
            "why retrieved",
            "contradictions instead of overwriting",
            "user run rust backend",
        ),
        "partial",
        "high",
        (
        ...
        "OMH can evaluate memory-provider plugins for provenance, retention, backend authority, retrieval evidence, and safety boundaries before provider selection or recall output is claimed.",
    ...
    CoverageRule(
        (
            ...
            "hermes kagi plugin",
            "kagi web search",
            "search and extract provider",
            "search extract provider",
        ),
        "partial",
        "high",
        (
        ...
        "OMH can review public search-provider plugins for provider choice, source quality, cost, credentials, and freshness before live retrieval or extracted content is claimed.",
    ...
    CoverageRule(
        ...
        "OMH can prepare social automation intent, connector readiness, content safety, and mutation approval cards while external posting or account access remains observed-only.",
    ...
    CoverageRule(
        (
            ...
            "curator evolver",
            "evidence driven companion",
            "dry run proposals",
            "guarded daily autorun",
            "hermes skill view",
            "skill view",
            "skill recommendation",
            "pre message reasoning middleware",
        ),
        "partial",
        "high",
        ("skill-health", "workflow-learning", "skill-scout", "agent-evaluation", "verification-gate", "instinct-ledger"),
        "OMH can route skill-governance plugins through skill health, learning, evaluator, and verification surfaces before generated recommendations or applies are trusted.",
        "public_skill_governance_plugin",
    ),
    CoverageRule(
        (
            "tokentelemetry hermes plugin",
            "tokentelemetry launcher tab",
            "token telemetry",
            "local observability for hermes agent",
        ),
        "partial",
        "medium",
        (
        ...
        "OMH can review observability plugins for local metrics scope, dashboard evidence, token/cost interpretation, and production-readiness boundaries without claiming live telemetry ingestion.",
    ...
    CoverageRule(
        ...
        "partial",
        "medium",
        ("content-operator", "research-department", "research", "data-analysis", "skill-scout"),
    ...
    CoverageRule(
        ...
        "partial",
        "high",
        ("memory-sync", "wiki", "prompt-import-readiness", "external-connector-readiness", "skill-scout"),
    ...
    CoverageRule(
        ...
        "partial",
        "high",
        ("ultrawork", "agent-board", "harness-session-inventory"),
    ...
    CoverageRule(
        ...
        "partial",
        "high",
        ("memory-sync", "wiki", "workflow-learning", "instinct-ledger", "skill-health"),
