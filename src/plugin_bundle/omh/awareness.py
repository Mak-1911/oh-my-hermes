...
WORKFLOW_CONTEXT_CARDS = (
    ...
    },
    {
        ...
        "user_signal": "new durable memory, existing memory cleanup, wiki, durable notes, Obsidian, Notion, Drive, or external store",
        "omh_pattern": "split new-memory capture from existing-memory cleanup; prepare source-backed notes and destination hints; writes need evidence",
        "representative_workflows": ("memory-new", "memory-sync", "wiki"),
        "user_examples": ("Capture this project decision", "Clean up stale Hermes memories", "Wiki"),
...
def awareness_primer_payload() -> dict[str, object]:
    ...
    lanes = [
        ...
        },
        {
            "id": "retained_knowledge",
            "label": "Retained knowledge",
            "skills": ["memory-new", "memory-sync", "wiki"],
            "use_for": "new/curated memory, wiki notes, retrieval, and staleness",
        },
        {
            "id": "materials_and_visuals",
