...
_DEFINITIONS = [
    ...
    SkillDefinition(
        ...
        "Hermes Security Safety Review workflow: review prompt, tool, secret, dependency, and destructive-action risks before agent or code execution.",
        (
            "security-safety-review",
            "security safety review",
            "ai coding safety",
...
_HARNESSES = [
    ...
    HarnessDefinition(
        ...
        "Record security-safety-review as Hermes-retained safety review; record scanners, dependency changes, permission changes, credential checks, and fixes only from observed evidence.",
        "metadata_only",
        quality_tier="security-safety-gated",
        quality_bar=(
...
_FEATURE_SURFACE_HARNESSES = (
    ...
    _feature_surface_harness(
        ...
        "Use when new durable context should enter capture/review/approval instead of existing-memory cleanup.",
        ("new durable fact", "project or product scope", "source context", "target store", "review owner"),
        ("memory_new_candidate/v1", "review decision", "dual-store target", "write boundary"),
        ...
        overclaim_guard="An OMH project-memory candidate is not an approved record or Hermes internal-memory mutation evidence.",
    ),
    _feature_surface_harness(
        "memory-sync",
        ...
        "Use when accumulated existing memory files or skill memories need human-approved cleanup, not new-memory capture.",
