...
_HARNESSES = [
    ...
    HarnessDefinition(
        ...
        ("validate loopability_assessment/v1", "validate loop_cycle/v1", "inspect loop_engineering/v1 snapshot", "inspect loop_runtime/v1 queue verification_plan", "inspect loop_status_card/v1 failure_mode_summary", "inspect loop_queue_handoff/v1 when a queued item is actionable", "check linked goal_completion_gate/v1 before completion copy", "inspect loop_goal_driver_handoff/v1 before pasting the /goal driver command"),
