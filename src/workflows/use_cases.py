...
USE_CASES: tuple[UseCase, ...] = (
    ...
    UseCase(
        ...
        feature_surface="github-event-ops workflow skill: PR/issue/CI event classification with label/review/fix-handoff actions.",
    ...
    UseCase(
        ...
        harness="agent-board",
        feature_surface="agent-board workflow skill: task/handoff/heartbeat/block/complete cards connected to OMH status.",
    ...
    UseCase(
        goal="G4",
        priority=4,
        id="project-terminology-alignment",
        title="Project terminology alignment",
        hermes_use_case="Align repository-specific language, answer safe term lookups, and close dependency-ready terminology decisions before planning.",
        current_gap="OMH had reviewed vocabulary storage, but no complete Hermes workflow for portable project-language alignment and decision-frontier closure.",
        primary_skill="context",
        playbook="deep-interview-to-plan",
        harness="deep-interview",
        feature_surface="context workflow skill: source-aware lookup, pending-only reviewed capture, dependency-ready frontier, and confirmed plan/handoff transition.",
        direct_skill_invocation="$context Align the terminology this project uses before planning.",
        hermes_chat_prompt="Use OMH ulw-context for: Align the project terminology and review PROJECT_TERMS before planning.",
        next_action="prepare_project_terms_context",
        user_value="Teams and selected coding owners can share reviewed repository language without turning glossary prose into routing authority.",
        evidence_boundary="A project-terms source, pending candidate, reviewed profile, or prepared handoff is not routing authority, model use, execution, review, CI, or merge evidence.",
        proof_surfaces=("omh recommend", "omh playbook inspect deep-interview-to-plan", "omh harness inspect deep-interview"),
        keywords=("project terminology", "project terms", "PROJECT_TERMS", "language alignment", "canonical term", "ulw-context"),
    ),
    UseCase(
        goal="G5",
        priority=5,
        ...
        feature_surface="gateway-intent-card workflow skill: origin, thread, delivery, silence, attachment, and status-update policy.",
    ...
    UseCase(
        ...
        feature_surface="executor-runtime-readiness workflow skill: runtime matrix, missing tools, worktree posture, and handoff mode.",
    ...
    UseCase(
        ...
        feature_surface="voice-operator workflow skill: short voice/mobile command normalization, ambiguity check, and safe confirmation card.",
    ...
    UseCase(
        ...
        feature_surface="toolbelt-readiness workflow skill: workflow tool requirements, installed/missing/credential matrix, and next setup action.",
    ...
    UseCase(
        ...
        title="Ops command-board and service quality card",
        hermes_use_case="Keep automation, loop, and service operations from failing silently by showing token/cost/latency/run-history/failure-mode telemetry, supplied metric-provider payloads, and service-quality downgrade gaps.",
        current_gap="OMH evidence boundaries were strong, but runtime cost/latency telemetry and provider-neutral service-quality contracts were weak.",
        primary_skill="ops-observability-card",
        playbook="ops-observability-card",
        harness="ops-observability-card",
        feature_surface="ops-observability-card workflow surface: wrapper-safe token, cost, latency, run history, queue, failure-mode, external metric-provider, and service-quality command-board.",
        direct_skill_invocation="$ops-observability-card Show token, cost, latency, supplied metrics, and service-quality gaps for this loop.",
        hermes_chat_prompt="Use OMH ops-observability-card for: Show token, cost, latency, supplied metrics, and service-quality gaps for this loop.",
        next_action="prepare_ops_observability_card",
        user_value="Operators can see health/cost/service-quality signals without confusing supplied exports with live provider truth or completion evidence.",
        evidence_boundary="An ops observability card is not billing truth, provider quota truth, live metric-provider access, complete tracing, SLO pass, incident closure, remediation completion, performance proof, or workflow completion evidence.",
...
USE_CASE_REPLAY_FIXTURES: tuple[UseCaseReplayFixture, ...] = (
    ...
    UseCaseReplayFixture("g4-context-en", "G4", "en", "Align project terminology and review project terms before planning."),
    UseCaseReplayFixture("g4-context-ko", "G4", "ko", "ulw-context로 프로젝트 용어를 계획 전에 정렬해줘."),
