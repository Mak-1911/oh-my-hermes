...
def _pending_candidate(record: Mapping[str, object], candidate_id: str, revision: int, lifecycle: str) -> dict[str, object]:
    ...
    replacement = {key: record[key] for key in ("record_type", "summary", "scope", "source_class", "source_ref", "retention", "revalidation", "ttl", "staleness", "derived_from") if key in record}
