...
GROUNDED_SCENARIOS: tuple[GroundedScenario, ...] = (
    ...
    GroundedScenario(
        ...
        "Korean Codex current-activity status resolves the owner-selection surface",
        "코덱스가 지금 뭐하고있는지 알려줘",
        "executor-runtime-readiness",
        "executor_runtime_readiness",
        "prepare_executor_runtime_readiness",
    ...
    GroundedScenario(
        ...
        "Direct legacy ultraprocess invocation follows the delivery alias",
